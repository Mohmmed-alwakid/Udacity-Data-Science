...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        city_name = input("\nwhat is the name of the city to analyze data for? Please input either Chicago, New york city or Washington.\n ")
        if city_name.lower() in CITY_DATA:
            ...
            print("sorry we are not able to get the name of the city to analyze data for, Please input either Chicago, New york city or Washington.\n")
    ...
    while month_name.lower() not in MONTH_DATA:
        ...
        if month_name.lower() in MONTH_DATA:
            ...
            print("Sorry we are not able to get the name of the months to filter data, Please input either 'All' to apply no month filter or  january,  february, . . . , june.\n")

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_name = ''
    while day_name.lower() not in DAY_DATA:
        day_name = input("\nwhat is the name of the day to filter data for?")
        if day_name.lower() in DAY_DATA:
            #We were able to get the name of the month to analyze data.
            day = day_name.lower()
        else:
            #We were not able to get the name of the month to analyze data so we continue the loop.
            print("Sorry we are not able to get the name of the day to filter data, Please input either 'All' to apply no day filter or monday, tuesday, ... Sunday.\n")
